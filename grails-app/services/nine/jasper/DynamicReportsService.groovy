...
class DynamicReportsService {
    ...
    JasperReportBuilder buildDynamicReport(def domainClass, def config, def params) {
        ...
        Map columns = DomainMetaUtils.buildColumnMap(domainClass, fields, config)

        JasperReportBuilder drb = setupReportBuilder()
