...
//
//        List fields = config.fields //?: getPropertyValue(domainClass.clazz, 'reportColumns') ?: domainClass.properties.name - ['id', 'version']
//
//        Map columns = dynamicJasperService.addColumns(config, domainClass, fields)
//
//        DynamicReportBuilder drb = dynamicJasperService.setupReportBuilder()
//
//        List groupFields = config.groupFields
//        Map groupVariables = config.groupVariables
//        //config.groupFooterColumns
//
//        List<DJGroup> djGroups = dynamicJasperService.buildGroupBands(columns, groupFields, groupVariables)
